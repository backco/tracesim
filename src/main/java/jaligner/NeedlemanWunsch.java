...
public final class NeedlemanWunsch {
    ...
    public static Alignment align (
		    Sequence s1, Sequence s2, Matrix matrix, float gap ) {
    ...
    private static Cell construct (
		    Sequence s1, Sequence s2, float[][] matrix, float gap, byte[][] pointers ) {
    ...
    private static Alignment traceback (
		    Sequence s1, Sequence s2, Matrix m, byte[][] pointers, Cell cell ) {
