...
public final class SmithWatermanGotoh {
    ...
    public static Alignment align (
		    Sequence s1, Sequence s2, Matrix matrix, float o, float e ) {
    ...
    private static Cell construct (
		    Sequence s1, Sequence s2, float[][] matrix, float o, float e, byte[] pointers, short[] sizesOfVerticalGaps, short[] sizesOfHorizontalGaps ) {
    ...
    private static Alignment traceback (
		    Sequence s1, Sequence s2, Matrix m, byte[] pointers, Cell cell, short[] sizesOfVerticalGaps, short[] sizesOfHorizontalGaps ) {
