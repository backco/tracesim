...
/**
 * Testing the scores of the alignments of {@link NeedlemanWunschGotoh}.
 *
...
public class NeedlemanWunschGotohTester {
	...
	try {
		...
		if ( s1.length() > 0 && s2.length() > 0 && o >= e ) {
		    ...
		    Alignment alignment1 = NeedlemanWunschGotoh.align(seq1, seq2, matrix, o, e);
		    ...
		    Alignment alignment2 = NeedlemanWunschGotoh.align(seq2, seq1, matrix, o, e);
		    if ( !alignment1.checkScore() ) {
			System.err.println("Invalid alignment found:");
